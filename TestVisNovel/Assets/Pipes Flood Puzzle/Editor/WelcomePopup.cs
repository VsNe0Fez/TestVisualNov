...
public class WelcomePopup : EditorWindow
{
	...
	void OnGUI ()
	{
		...
		EditorGUILayout.TextArea ("Thank you for buying/downloading Pipes Flood Puzzle Package.\nIf you have any questions, suggestions, comments , feature requests or bug detected,\ndo not hesitate to Contact US.\n", GUI.skin.label);
		EditorGUILayout.Separator ();

		EditorGUILayout.TextArea ("We always strive to provide high quality assets. If you have enjoyed with Pipes Flood Puzzle,\nwe would be happy if you would spend few minutes and write a review for us on the \n" + Links.storeName + ".\n", GUI.skin.label);
		EditorGUILayout.Separator ();
